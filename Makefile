...
ACLOCAL = ${SHELL} /c/xz-5.2.2/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
AR = ar
AS = as
AUTOCONF = ${SHELL} /c/xz-5.2.2/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /c/xz-5.2.2/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /c/xz-5.2.2/build-aux/missing automake-1.15
AWK = gawk
CC = gcc
CCAS = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /c/xz-5.2.2/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
abs_builddir = /c/xz-5.2.2
abs_srcdir = /c/xz-5.2.2
abs_top_builddir = /c/xz-5.2.2
abs_top_srcdir = /c/xz-5.2.2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /c/xz-5.2.2/build-aux/install-sh
